<template>
  <div class="bannerContainer">
    <img src="@/assets/images/hero img.png" alt="Geografisk Have" class="banner-image"/>
    <img src="@/assets/images/geografiskhave_logo_hvid_med_tekst.svg" alt="logo" class="geografisk-logo">
  </div>
